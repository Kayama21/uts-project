  ...
  <div class="col-md-9">
    <div class="card-container">
        <div class="row card-product">
            <div class="cardmenu-3" v-for="(jaket, index) in Jaket" :key="index">
...
export default {
  ...
  methods: {
    getAll () {
      axios.get('https://raw.githubusercontent.com/Kayama21/uts-project/master/product.json')
        .then((result) => {
          this.Jaket = result.data.Jaket
